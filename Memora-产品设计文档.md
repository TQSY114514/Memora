...
定位语：**「Your memory, not your tools.」换 AI，不换人生积累。**

Memora 是面向普通终端用户的 **跨 AI 一致的个人记忆层**：Local-First 存储，让用户在更换任意模型、任意平台时，其对话记忆、偏好与知识积累保持连续——工具服务于你，记忆归属于你。
...
> **你的记忆属于你，工具为你服务。**
> **换 AI，不换人生积累。**
> 无论换多少次模型、多少个平台，你的偏好、决策与知识都延续到下一个 AI——`Your memory, not your tools.`
