      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto">
        {sortedSessions.length === 0 && (
          <div className="px-8 py-16 text-center">
            <div className="mx-auto mb-3 w-10 h-10 rounded-lg border border-dashed border-border-strong flex items-center justify-center text-fg-muted opacity-60">
